...
class Loader
{
    ...
    private static function setLookupPath(Array $paths = null) {
        ...
        GTMVC_ROOT_PATH . "_lib/",
        GTMVC_ROOT_PATH . "_lib/model/",
        GTMVC_ROOT_PATH . "_lib/dao/",
        GTMVC_ROOT_PATH . "_lib/controller/",
        GTMVC_ROOT_PATH . "_lib/exceptions/"
        );

        // set default lookup path for special classes
        self::$special_classes ["Smarty"] = GTMVC_ROOT_PATH . "_lib/extlib/Smarty-2.6.26/libs/Smarty.class.php";
    ...
    public static function definePathConstants() {
        if ( !defined('GTMVC_ROOT_PATH') ) {
            $local_path = str_replace('\\','/',dirname(dirname(__FILE__)));
			
			
			
			define('GTMVC_ROOT_PATH',$local_path.'/');
        }
    }
